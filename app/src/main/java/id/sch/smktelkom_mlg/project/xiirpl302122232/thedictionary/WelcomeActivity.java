...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private class MyViewPagerAdapter extends PagerAdapter {
        private LayoutInflater layoutInflanter;
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            layoutInflanter = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);

            View view = layoutInflanter.inflate(layouts[position], container, false);
